...
<head>
    ...
    <title>GWSC Blog</title>
</head>
<body>
    <section class="bolgheader mt-3">
        <div class="container">
            <div class="row">
    ...
    <section class="btitle text-center mt-3">
        <div class="container">
            <div class="row">
                <div class="col-md-2"></div>
                <div class="col-md-8">
                    <h2>B L O G</h2>
                    <h5 class="text-muted">By GWSC</h5>
                </div>
                <div class="col-md-2"></div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="card text-bg-dark">
                        <img src="./images/card4.jpg" class="card-img" alt="...">
